...
% Safe include to avoid hard errors when sample assets are missing
\newcommand{\MaybeIncludeGraphics}[2][]{%
  \IfFileExists{#2}{\includegraphics[#1]{#2}}{\textit{[missing graphic: #2]}}%
}
...
\MaybeIncludeGraphics{figs/cas-grabs.pdf}
...
\begin{figure}
	\centering
  \MaybeIncludeGraphics[width=.9\columnwidth]{figs/cas-munnar-2024.pdf}
...
\begin{figure*}
	\centering
  \MaybeIncludeGraphics[width=.9\textwidth]{figs/cas-munnar-2024.pdf}
	\caption{The beauty of Munnar, Kerala. (See also Table \protect\ref{tbl1}).}
	\label{FIG:2}
\end{figure*}
...
\IfFileExists{figs/cas-pic1}{\bio{figs/cas-pic1}}{\bio{}}
