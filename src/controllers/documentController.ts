...
export const createDocument = asyncHandler(
	async (req: Request, res: Response) => {
		...
		try {
			...
			logger.info("Document permissions initialized", {
				documentId: document.documentId,
				userId,
			});
		} catch (permissionError) {
			logger.error(
				"Failed to initialize document permissions:",
				permissionError,
			);
 ...
 */
export const getWorkspaceDocuments = asyncHandler(
	async (req: Request, res: Response) => {
		const workspaceId = req.params.workspaceId as string;
...
export const getDocumentById = asyncHandler(
	async (req: Request, res: Response) => {
		...
		if (document.currentVersionId) {
			currentVersion = await documentBodyRepository.findById(
 ...
 */
export const getDocumentWithRoomState = asyncHandler(
	async (req: Request, res: Response) => {
		const documentId = req.params.documentId as string;
 ...
 * Protected (requires edit permission)
 */
export const updateDocumentContent = asyncHandler(
	async (req: Request, res: Response) => {
		const documentId = req.params.documentId as string;
...
export const deleteDocument = asyncHandler(
	async (req: Request, res: Response) => {
		...
		try {
			...
			logger.warn(
				`Failed to delete liveblocks room for document ${documentId}:`,
				err,
			);
		}
 ...
 * Protected
 */
export const getUserDocuments = asyncHandler(
	async (req: Request, res: Response) => {
		const userId = req.userId!;
