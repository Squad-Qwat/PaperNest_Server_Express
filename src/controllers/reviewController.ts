...
import { NotFoundError, ForbiddenError, BadRequestError } from '../utils/errorTypes';
...
export const createReview = asyncHandler(async (req: Request, res: Response) => {
  ...
  logger.info('Create review request', { documentId, documentBodyId, lecturerUserId, studentUserId });
  ...
  return createdResponse(res, { review }, 'Review request created successfully');
});
...
export const approveReview = asyncHandler(async (req: Request, res: Response) => {
  ...
  const review = await reviewRepository.updateStatus(reviewId, 'approved', message || '');
...
export const rejectReview = asyncHandler(async (req: Request, res: Response) => {
  ...
  const review = await reviewRepository.updateStatus(reviewId, 'rejected', message || '');
...
export const requestRevision = asyncHandler(async (req: Request, res: Response) => {
  ...
  const review = await reviewRepository.updateStatus(reviewId, 'revision_required', message);
