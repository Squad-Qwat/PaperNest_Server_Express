 ...
 * Protected (requires document access)
 */
export const getDocumentComments = asyncHandler(
	async (req: Request, res: Response) => {
		const documentId = req.params.documentId as string;
 ...
 * Protected (requires document access)
 */
export const getRootComments = asyncHandler(
	async (req: Request, res: Response) => {
		const documentId = req.params.documentId as string;
 ...
 * Protected (requires document access)
 */
export const resolveComment = asyncHandler(
	async (req: Request, res: Response) => {
		const commentId = req.params.commentId as string;
 ...
 * Protected (requires document access)
 */
export const unresolveComment = asyncHandler(
	async (req: Request, res: Response) => {
		const commentId = req.params.commentId as string;
